...
import org.kharisov.exceptions.InvalidUserException;
...
public class DtoInValidator {
     ...
     * @throws InvalidUserException если DTO не проходит валидацию.
     */
    public static <T> void validate(T dto, Class<?>... groups) {
        ...
        if (!violations.isEmpty()) {
            throw new InvalidUserException("Data entered incorrectly");
        }
    }
}
