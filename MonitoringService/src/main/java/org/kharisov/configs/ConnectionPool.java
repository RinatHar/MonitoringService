...
public class ConnectionPool {
    ...
    @Autowired
    public ConnectionPool(DatabaseProperties databaseProperties) {
        this.url = databaseProperties.getUrlAndSchema();
        this.user = databaseProperties.getUsername();
        this.password = databaseProperties.getPassword();
        this.MAX_POOL_SIZE = databaseProperties.getSizePool();
        this.connectionPool = new ArrayList<>(MAX_POOL_SIZE);
