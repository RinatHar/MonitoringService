...
public class JwtUtils {
     ...
     * @param accessTokenDuration Продолжительность действия токена доступа в минутах.
     * @param refreshTokenDuration Продолжительность действия токена обновления в минутах.
     */
